...
if ($_GET["Command"] == "meal_list") {
    ...
    $sql = "Select * from addmeal_item where room_no ='" . $_GET["roomno"] . "' and cancel='0'";
...
//        $ResponseXML .= "<id><![CDATA[" . $row['tour_no'] . "]]></id>";
        ...
        $sql4 = "Select * from addmeal_item where room_no ='" . $_GET["roomno"] . "' order BY room_no";
        $gtot = 0;
        foreach ($conn->query($sql4) as $row2) {
            $ResponseXML .= "<tr>
                         ...
                         <td style='width: 180px;'> <input disabled  type='text' placeholder='Amount' value='" . $row2['amount'] . "' id='amount' class='form-control input-sm'></td>  
    ...
    $ResponseXML .= "<mealcharge><![CDATA[" . $gtot . "]]></mealcharge>";
    $ResponseXML .= "</salesdetails>";
    echo $ResponseXML;
}
...
//        }
    ...
    $ResponseXML .= "<sales_table><![CDATA[<table class = \"table\">
                        <th style='width: 20px;
            text-align: center'>Meal/Drink</th>
                        <th style='width: 20px;
            text-align: center'>Qty</th>
                        <th style='width: 10px;
            text-align: center'>Date/Time</th>
                        <th style='width: 120px;
            text-align: center'>Note</th>
                        <th style='width: 10px;
            text-align: center'>Amount</th>
                        <th style='width: 10px;
            text-align: center'>Sub Amount</th>
                        <th style='width: 10px;
    ...
    foreach ($conn->query($sql) as $row) {
        $ResponseXML .= "<tr>  
            ...
            '> <input disabled type='text' placeholder='Meal/Drink' value='" . $row['meal'] . "' id='meal' class='form-control input-sm'></td>
                         <td style='width: 150px;
            '> <input disabled type='text'  placeholder='Qty' value='" . $row['qty'] . "' id='qty' class='form-control input-sm'></td>
                         <td style='width: 320px;
            '> <input disabled type='text'  value='" . $row['datetime'] . "' id='datetime' class='form-control input-sm'></td>
                         <td style='width: 360px;
            '> <input disabled type='text' placeholder='Note' value='" . $row['note'] . "' id='note' class='form-control input-sm'></td>
                         <td style='width: 180px;
            '> <input   type='text' placeholder='Amount' value='" . $row['amount'] . "' id='amount' class='form-control input-sm'></td>  
                         <td style='width: 180px;
            '> <input disabled type='text' placeholder='Sub Total' value='" . $row['qty'] * $row['amount'] . "' id='subtotal' class='form-control input-sm'></td>  
...
//        $ResponseXML .= "<id><![CDATA[" . $row['tour_no'] . "]]></id>";
        ...
        foreach ($conn->query($sql4) as $row2) {
            $ResponseXML .= "<tr>
                          <td style='width: 380px;
            '> <input disabled type='text' placeholder='Meal/Drink' value='" . $row2['meal'] . "' id='meal' class='form-control input-sm'></td>
                         <td style='width: 150px;
            '> <input disabled type='text'  placeholder='Qty' value='" . $row2['qty'] . "' id='qty' class='form-control input-sm'></td>
                         <td style='width: 320px;
            '> <input disabled type='text'  value='" . $row2['datetime'] . "' id='datetime' class='form-control input-sm'></td>
                         <td style='width: 360px;
            '> <input disabled type='text' placeholder='Note' value='" . $row2['note'] . "' id='note' class='form-control input-sm'></td>
                         <td style='width: 180px;
            '> <input   type='text' placeholder='Amount' value='" . $row2['amount'] . "' id='amount' class='form-control input-sm'></td>  
                         <td style='width: 180px;
            '> <input disabled type='text' placeholder='Sub Total' value='" . $row2['qty'] * $row2['amount'] . "' id='subtotal' class='form-control input-sm'></td>  
...
if ($_GET["Command"] == "roomcharge_tot") {
    header('Content-Type: text/xml');
    ...
    $total = $_GET["roomcharge"] + $_GET["wifi"] + $_GET["ac"] + $_GET["damage"] + $_GET["other"];
    $tot = ($total);
...
if ($_GET["Command"] == "get_list") {
    ...
    // echo $_GET['term'];
    $result = array();
    $sql = "select name from booking_main where name like '%" . $_GET['term'] . "%' limit 50";
 
    foreach ($conn->query($sql) as $items) {
        array_push($result, array("id" => $items['name'], "label" => $items['name']));
